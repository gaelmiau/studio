export function Header() {
  return (
    <header className="relative py-3 px-4 md:px-8 border-b-2 border-primary/20 bg-white">
      {/* Pleca arriba a la derecha */}
      <div className="absolute top-0 right-0 flex items-center justify-center px-4 py-2"
           style={{
