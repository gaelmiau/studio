    ...
    <>
      ...
      <main className="flex min-h-screen flex-col bg-background text-foreground p-6">
        ...
        <Card className="shadow-md rounded-2xl mb-6">
          <CardContent className="p-4 text-center bg-[#32325E]/100 rounded-xl">
            <h2 className="text-[18px] font-bold">Modos de juego</h2>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-md rounded-2xl mb-6">
          <CardContent className="p-4 text-center bg-[#32325E]/100 rounded-xl">
            <h2 className="text-[18px] font-bold">Reglas del juego</h2>
          </CardContent>
        </Card>
